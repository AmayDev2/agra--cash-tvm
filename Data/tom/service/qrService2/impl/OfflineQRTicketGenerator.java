...
public class  OfflineQRTicketGenerator extends QRTicketGenerator {
    ...
    public OfflineQRTicketGenerator(TicketsRepository ticketsRepository, ScuService scuService, Shift shift, ThreadPool threadPool, ScuService ccuService, TicketIdGeneratorService ticketIdGeneratorService) {
