...
public class PartialOnlineQRTicketGenerator extends AbstractQRTicketGenerator {
    ...
    public QRTicketGenerator create(Agent agent) {
        return new com.amay.tom.service.qrService2.impl.PartialOnlineQRTicketGenerator(agent.getTicketsRepository(),agent.getScuService(),agent.getShift(),agent.getThreadPool(),agent.getCcuService(),agent.getShiftIdGeneratorService().getTicketIdGeneratorService());
    }
