...
public abstract class QRTicketAdjustment implements QRTicketService {
    ...
    @Override
    public ArrayList<GeneratedTicket> processTicket(String OrderId, String transactionId, com.amay.tom.service.qrService2.TicketInfo ticketInfo) {
    ...
    protected String saveIntoDb(AdjustedTicket adjustedTicket){
        ...
        adjustedTicket.setPaymentMode(PayMethod.CASH.name()); // TODO :assignation logic to be changed when more payment modes are introduced
    ...
    public abstract AdjustedTicket adjustTicket(String OrderId, String transactionId, com.amay.tom.service.qrService2.TicketInfo ticketInfo);
    public abstract AdjustedTicket adjustEntryTimeOverride(String OrderId, String transactionId, com.amay.tom.service.qrService2.TicketInfo ticketInfo);
    public abstract AdjustedTicket adjustExitTimeOverride(String OrderId, String transactionId, com.amay.tom.service.qrService2.TicketInfo ticketInfo);
