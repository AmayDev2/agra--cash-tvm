...
public class CommandHandler {
    ...
    public void handleCommand(org.network.monitorandcontrol.CommandType commandType, org.network.monitorandcontrol.tom.TOMProtocol value) {
        switch (commandType){
...
//            TOMModeControl tomModeControl = requestData.unpack(Any.class).unpack(TOMModeControl.class);
           TOMModeControl tomModeControl = requestData.unpack(TOMModeControl.class);
