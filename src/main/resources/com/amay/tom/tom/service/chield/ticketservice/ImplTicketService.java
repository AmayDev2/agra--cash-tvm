...
//        }
    ...
    public MetroTicket generateTicket(Station sourceStation, Station destinationStation, Station station, int noOfPassenger, TicketType selectedTicketType) {
        ...
        MetroTicket metroTicket = new MetroTicket(SystemConfig.getInstance().getLineNumber(), station, System.currentTimeMillis() / 1000, (int) ((selectedTicketType.equals(com.amay.tom.model.TicketType.RETURN) ? 24 : selectedTicketType.equals(com.amay.tom.model.TicketType.FREE) ? .25 : 1)), sourceStation, destinationStation, null, Fare.getTotalFare(sourceStation, destinationStation, noOfPassenger, selectedTicketType), selectedTicketType, noOfPassenger);
...
//            }
    ...
    private int getTicketQuantity(TicketType ticketType, int noOfPassenger) {
        if (ticketType.equals(com.amay.tom.model.TicketType.GROUP)) {
            return 1;
        }
